#!/usr/bin/env python3
"""Prepare high-increase regressions for negative feature steering."""
...
FEATURES = ((7608, "p95"),)
CASE = "deepseek_base_finetuned_layer16__bigcodebench__layer16__paired_transitions"
...
def main() -> None:
    ...
    for feature, aggregation in FEATURES:
        ...
        ].sort_values("differential", ascending=False).head(a.candidates_per_feature)
