...
run_arm_if_missing() {
  local arm_name="$1"
  local alpha="$2"
  local output="$run/generations/bigcodebench__f9537_alpha_${arm_name}_results.jsonl"
...
run_arm_if_missing "neg3" "-3"
run_arm_if_missing "pos1" "+1"
